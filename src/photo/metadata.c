...
static const ap_meta_descriptor FIELDS[] = {
    ...
    { AP_META_LENS_MIN_FOCAL,    "Lens Min Focal",    "lens_min_focal"    },
    { AP_META_LENS_MAX_FOCAL,    "Lens Max Focal",    "lens_max_focal"    },
    { AP_META_LENS_MIN_APERTURE, "Lens Min Aperture", "lens_min_aperture" },
